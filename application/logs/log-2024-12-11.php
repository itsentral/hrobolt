...
ERROR - 2024-12-11 17:12:16 --> Severity: Parsing Error --> syntax error, unexpected end of file C:\xampp_5_6\htdocs\hrobolt\application\modules\packing\views\index.php 513
ERROR - 2024-12-11 17:13:05 --> Severity: Parsing Error --> syntax error, unexpected end of file C:\xampp_5_6\htdocs\hrobolt\application\modules\packing\views\index.php 513
ERROR - 2024-12-11 17:13:44 --> Query error: BIGINT UNSIGNED value is out of range in '(cast(`hirobolt`.`app_parameter`.`value` as unsigned) - 1)' - Invalid query: UPDATE app_parameter SET VALUE=RIGHT(CONCAT('0',CAST(VALUE AS UNSIGNED)-1),1) WHERE CODE='JP'
