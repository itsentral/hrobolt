    ...
    <div class="box-body">
		<form id="data-form" method="post">
					...
					<select id="id_category3" name="id_category3" class="form-control select" onchange="getproperties()" required>
						...
						?>
						<option value="<?= $inventory_3->id_category3?>"><?= ucfirst(strtolower($inventory_3->nm_bentuk))?>-<?= ucfirst(strtolower($inventory_3->nama_category2))?>-<?= ucfirst(strtolower($inventory_3->nama))?>-<?= ucfirst(strtolower($inventory_3->hardness))?>-<?= ucfirst(strtolower($inventory_3->nilai_dimensi))?></option>
						<?php } ?>
					</select>
									    </div>
										</div>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
									    ...
									    <div class='col-md-8'>
										<input type='text' class='form-control' id='forecast' required name='forecast' placeholder='Forecats/Month'>
									    </div>
										</div>
						</div>	
						<div class="col-sm-6">
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>LOT. NO Alloy</label>
									    </div>
									    <div class='col-md-8'>
										<input type='text' class='form-control' id='lotno' required name='lotno' placeholder='LOT. NO Alloy'>
									    </div>
										</div>
						</div>	
						<div class="col-sm-6">
