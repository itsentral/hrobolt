		...
		<form id="data-form" method="post">
			<div class="col-sm-12">
				<div class="input_fields_wrap2">
					<div class="row">
						<center><label for="customer"><h3>DETAIL IDENTATIS SUPPLIER</h3></label></center>
						<div class="col-sm-6">
							<div class="form-group row">
								<div class="col-md-6">
									<label for="id_supplier">Code Supplier</label>
								</div>
								<div class="col-md-6">
						...
						<div class="col-sm-12">
							<center>
								<button type="submit" class="btn btn-success btn-md col-md-12 col-sm-12" name="save" id="simpan-com"><i class="fa fa-save"></i> Simpan</button>
							</center>
						</div>
					</div>
				</div>
