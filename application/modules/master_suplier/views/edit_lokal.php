			...
			<div class="col-sm-12">
				<div class="input_fields_wrap2">
					<div class="row">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<select id="id_kota" name="id_kota" class="form-control select" required>
										...
										?>
										<option value="<?= $kota->id_kab?>" <?= $select ?>><?= $kota->nama?></option>
										<?php } ?>
									</select>
								</div>
							</div>
						...
						<div class="col-sm-12">
							<center>
								<button type="submit" class="btn btn-success btn-md col-sm-12 col-md-12" name="save" id="simpan-com"><i class="fa fa-save"></i> Simpan</button>
							</center>
						</div>
					</div>
				</div>
