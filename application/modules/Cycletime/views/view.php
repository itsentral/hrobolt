		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-4"> <select disabled id="" name="hd1[1][costcenter]" class="form-control select" required>
										...
										<div class="col-md-4"><input readonly type="text" value="<?= $cycletime->machine?>" class="form-control" id="" required name="hd1[1][machine]" placeholder="Mechine"></div>
							...
							<tr id="tr_<?= $loop; ?>">
									...
									<td align='left'><input type='text' class="form-control" readonly value="<?= $detail->process; ?>" id="data1_<?= $loop; ?>_process" required name="data1[<?= $loop; ?>][process]" placeholder="Process"></td>
									<td align='left'><input type='number' class="form-control" readonly value="<?= $detail->cycletime; ?>" id="data1_<?= $loop; ?>_cycletime" required name="data1[<?= $loop; ?>][cycletime]" placeholder="cycletime/Minute"></td>
									<td align='left'><input type='number' class="form-control" readonly value="<?= $detail->qty_mp; ?>" id="data1_<?= $loop; ?>_qty_mp" required name="data1[<?= $loop; ?>][qty_mp]" placeholder="Manpower Qty"></td>
									<td align='left'><input type='text' class="form-control" readonly value="<?= $detail->note; ?>" id="data1_<?= $loop; ?>_note" required name="data1[<?= $loop; ?>][note]" placeholder="NOTE"></td>
