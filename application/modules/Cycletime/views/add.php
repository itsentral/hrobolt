					  ...
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-4"> <select id="" name="hd1[1][costcenter]" class="form-control select" required>
											...
											?>
											<option value="<?= $costcenter->id_costcenter?>"><?= ucfirst(strtolower($costcenter->nama_costcenter))?></option>
											<?php } ?>
										  </select></div>
										<div class="col-md-2"><label for="customer">Mechine</label></div>
									    <div class="col-md-4"><input type="text" class="form-control" id="" required name="hd1[1][machine]" placeholder="Mechine"></div>
										</div></div>
									<div class="row"><div class="form-group row">
									<?php
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'cycletime/saveNewbentuk';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
