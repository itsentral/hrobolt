	...
	<div class="box-body">
		...
		<tr>
			...
			<td><?php if($record->upload_po <> null) : ?> 
				<a class="btn btn-primary btn-sm" href="<?= base_url($record->upload_po)  ?>" title="View PO"><i class="fa fa-eye"></i>
				</a>
				<?php endif; ?>
			</td>
			<td><?php if($record->upload_so <> null) : ?> 
					<a class="btn btn-success btn-sm" href="<?= base_url($record->upload_so) ?>" title="View SO"><i class="fa fa-eye"></i>
				    </a>
					<?php endif; ?>	
			</td>
			...
			<?php if($ENABLE_MANAGE)  : ?>
			<a class="btn btn-primary btn-sm" target='_blank' href="<?= base_url('/sales_order/printSO/'.$record->no_so) ?>" title="Print SO" ><i class="fa fa-print">&nbsp;Print SO</i>
			</a> 
			<?php endif; ?>
