<?php
    $ENABLE_ADD     = has_permission('Kategori_Stock.Add');
    $ENABLE_MANAGE  = has_permission('Kategori_Stock.Manage');
    $ENABLE_VIEW    = has_permission('Kategori_Stock.View');
    $ENABLE_DELETE  = has_permission('Kategori_Stock.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
