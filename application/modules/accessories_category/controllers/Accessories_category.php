...
{
    //Permission
    protected $viewPermission 	= 'Kategori_Stock.View';
    protected $addPermission  	= 'Kategori_Stock.Add';
    protected $managePermission = 'Kategori_Stock.Manage';
    protected $deletePermission = 'Kategori_Stock.Delete';
