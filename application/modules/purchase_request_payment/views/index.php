...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td align="right"><?= number_format($record->subtotal,2)?></td>
			<td style="padding-left:20px">
			
			<?php if($ENABLE_MANAGE) : 
				if($record->status == '2'){?>
				<a class="btn btn-info btn-sm" href="<?= base_url('/purchase_order_payment/edit/'.$record->no_po) ?>" title="Create Pembayaran" ><i class="fa fa-plus"></i></a>
