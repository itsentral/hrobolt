        ...
        <div class="col-sm-12">
            <div class="col-sm-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8"> 
                    <input type="input" class="form-control" id="total_po" value="<?= number_format($head->subtotal,2) ?>" onkeyup required name="total_po" readonly >
					</div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
				<div class="form-group row">
					...
					<div class="col-md-8">
                    <input type="input" class="form-control" id="total_bayar" value="<?= number_format($hutang->rencana_bayar_idr)?>" onblur="separator()" required name="total_bayar" readonly >	
					</div>
				</div>
			</div>
		</div> 
