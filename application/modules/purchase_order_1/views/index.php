...
<div class="box">
	<div class="box-header">
		<span class="pull-left">
			<?php if($ENABLE_ADD) : ?>
				<a class="btn btn-success btn-md" href="<?= base_url('/purchase_order/addPurchaseorder/') ?>" title="Add" ><i class="fa fa-plus"></i>&nbsp; Buat PO</a>
			<?php endif; ?>
		</span>
	</div>
	<!-- /.box-header -->
	<!-- /.box-header -->
	<div class="box-body">
		<table id="table-purchase-order" class="table table-bordered table-striped">
		<thead>
		<tr>
			<th width="5">#</th>
			<th >No PO</th>
