					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="id_customer">Supplier On Purchase Request</label>
									</div>
									<div class="col-md-8"> 
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<!-- onchange="get_kurs()" -->
										<select id="loi" name="loi" class="form-control select"    required>
											<option value="">--Pilih--</option>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="customer">No. Purchase Order</label>
									</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="customer">Tanggal Purchase Order</label>
									</div>
									<div class="col-md-8">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="id_customer">Tanggl Dikirm</label>
									</div>
									<div class="col-md-8">
										<input type="text" class="form-control" id="tanggal_kirim" onkeyup required name="tanggal_kirim">
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<select id="term" name="term" class='form-control input-md chosen-select' required>
												<option value="">Silahkan Pilih</option>
												<?php foreach ($results['tops'] as $top){
												$selected = '';	
													?> 
													<option value="<?= $top->data1?>" <?=$selected;?>><?= strtoupper(strtolower($top->name))?></option>
												<?php } ?>
										</select>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-8"> 
										<select id="matauang" name="matauang" class='form-control input-md chosen-select' required>
												<option value="">Silahkan Pilih</option>
												<?php foreach ($results['mata_uang'] as $matauang){
												$selected = '';	
													?> 
													<option value="<?= $matauang->kode?>" <?=$selected;?>><?= strtoupper(strtolower($matauang->kode))?></option>
												<?php } ?>
										</select>
									</div>
								</div>
