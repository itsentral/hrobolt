	...
	<div class="box-body">
		<table id="example1" class="table table-bordered table-striped">
			<thead>
				<tr>
					<th width="5">#</th>
					<th>Tipe Produk (LV I)</th>
					<th>Brand Produk (LV II)</th>
					<th>Kode SKU Brand</th>
					<th>Status</th>
					<!-- <th>Komposisi</th> -->
			...
			?>
				<tr>
					...
					<!-- <td>
						<?php
							if(count($record['children']) > 1) {
								foreach ($record['children'] AS $child)
								{
									echo "<ul>";
									echo "<li>" . $child['name_compotition'] . "</li>";
									echo "</ul>";
								}
							} else {
									echo "<ul>";
									echo "<li>" . $record['children']['name_compotition'] . "</li>";
									echo "</ul>";
							}
						?>
					</td> -->
					...
					<?php if($ENABLE_VIEW) : ?>
						<a class="btn btn-primary btn-sm btn-view" href="javascript:void(0)" title="View" data-id_inventory2="<?=$record['id']?>"><i class="fa fa-eye"></i>
						</a>
					<?php endif; ?>

					<?php if($ENABLE_MANAGE) : ?>
						<a class="btn btn-success btn-sm edit" href="javascript:void(0)" title="Edit" data-id_inventory2="<?=$record['id']?>"><i class="fa fa-edit"></i>
						</a>
					<?php endif; ?>

					<?php if($ENABLE_DELETE) : ?>
						<a class="btn btn-danger btn-sm delete" href="javascript:void(0)" title="Delete" data-id_inventory2="<?=$record['id']?>"><i class="fa fa-trash"></i>
						</a>
					<?php endif; ?>
					</td>
				</tr>
