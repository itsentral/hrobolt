				...
				<div class="input_fields_wrap2">			
					<div class="row">
						<div class="form-group row">
							<div class="col-md-4">
								<label for="customer">Kategori Produk</label>
							</div>
							<div class="col-md-6">
								<select id="inventory_1"  name="inventory_1" disabled class="form-control select" required>
									<option value="">-- Inventory --</option>
									<?php foreach ($results['lvl1'] as $lvl1){ ?>
										<?php 
											$idType =  trim($lvl1->id);
											$idCategory1 = trim($inven->id_type);
											echo $idCategory1;
										 ?>
									<option value="<?= $idType ?>" <? echo ($idCategory1 == $idType) ? 'selected' : ''; ?> > <?= $lvl1->nama?> </option>
									<?php } ?>
					  			</select>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="" readonly required name="hd1[1][nm_inventory]" value="<?= $inven->nama ?>" placeholder="Nama Inventory">
							</div>
						</div>	
						<div class="form-group row">
							<div class="col-md-4">
								<label for="customer">Kode SKU Brand</label>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="" readonly required name="hd1[1][kode_sku]" value="<?= $inven->sku_code ?>" placeholder="SKU Code">
							</div>
						</div>				
						<div class="col-xs-2">
							&nbsp;
