...
class Master_kurs extends Admin_Controller
{
    ...
    public function index()
	{
        ...
        $listData = $this->db->order_by('id','desc')->get_where('ms_kurs',array('deleted_date'=>NULL))->result();
	...
	{	
      ...
      if($this->input->post()){
        ...
        $this->db->trans_start();
          if(empty($id)){
            $this->db->insert('ms_kurs',$dataProcess);
          }
          else{
            $this->db->where('id',$id);
            $this->db->update('ms_kurs',$dataProcess);
          }
        ...
        $listData = $this->db->get_where('ms_kurs',array('id' => $id))->result();
	...
	public function delete()
	{
      ...
      $this->db->trans_begin();
      $this->db->where('id',$id)->update("ms_kurs",$data);
    ...
    public function update_kurs_to_all()
	{
      ...
      $dataKurs = $this->db->get_where('ms_kurs',array('id'=>$id))->result();
