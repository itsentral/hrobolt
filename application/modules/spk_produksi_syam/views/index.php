						...
						<table id="example2" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<?php if($ENABLE_VIEW) : ?>
										<a class="btn btn-warning btn-sm view" href="<?= base_url('/spk_produksi/addHeader2/'.$record->id_spkproduksi.'/view') ?>" title="View"><i class="fa fa-eye"></i>
										</a>
									<?php endif; ?>
												<?php if($ENABLE_MANAGE) : ?>
									<a class="btn btn-primary btn-sm" href="<?= base_url('/spk_produksi/addHeader2/'.$record->id_spkproduksi) ?>"  title="Edit"><i class="fa fa-edit"></i></a>
									<?php endif; ?>
									<?php if($ENABLE_VIEW) : ?>
