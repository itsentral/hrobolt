                ...
                <td width="300" align="center">
                    <table width='300' align="center">
                        <tr>
                            ...
                            <td width='200' align="left" style="vertical-align: top;"></td>
                        </tr>
                        <tr>
                ...
                foreach ($detail as $detail) {
                    ...
                    if ($jumlahdata <= '30') {
                        ...
                        <tr >
                            ...
                            <td style='font-size: 8px; max-width: 250px !important; word-wrap: break-word;' align='right'>" . number_format(ceil($detail->qty / $detail->konversi), 2) . "</td>
