											...
											foreach ($results['getitemso'] as $value) {
												...
												<tr>
													<td>  " . $value->nm_material . $value->nm_material1 . "
											  		...
											  		<td>
														<input type='text' class='form-control input-sm' name='dt[" . $key . "][kode_barang]' id='dt_kode_barang_" . $key . "' value='" . $value->code . $value->code1 . "' readonly>
													</td>
											  
													<td>
														<input type='text' class='form-control input-sm' name='dt[" . $key . "][description]' id='dt_description_" . $key . "' value='" . $value->description . "'>
													</td>
