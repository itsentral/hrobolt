									...
									<div class="col-md-8">
										<select id="supplier" name="supplier" class='form-control input-md chosen-select' disabled>
											...
											<?php foreach ($results['list_supplier'] as $supplier) {
												$selected = '';
												if (isset($results['header_po']) && $supplier->code_supplier == $results['header_po']->id_suplier) {
													$selected = 'selected';
												}
											?>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<textarea name="reject_reason" id="" cols="30" rows="5" class="form-control form-control-sm"></textarea>
							</div>
						</div>
					</div>
					<div class="col-sm-12">
