 ...
 *
 */
class Master_unit_packing extends Admin_Controller
{
    //Permission
    protected $viewPermission 	= 'Unit_Packings.View';
    protected $addPermission  	= 'Unit_Packings.Add';
    protected $managePermission = 'Unit_Packings.Manage';
    protected $deletePermission = 'Unit_Packings.Delete';
