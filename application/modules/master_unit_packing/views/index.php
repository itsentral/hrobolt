<?php
    $ENABLE_ADD     = has_permission('Unit_Packings.Add');
    $ENABLE_MANAGE  = has_permission('Unit_Packings.Manage');
    $ENABLE_VIEW    = has_permission('Unit_Packings.View');
    $ENABLE_DELETE  = has_permission('Unit_Packings.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
