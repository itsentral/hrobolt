...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<th>Kode Kategory Marketplace</th>
			<th>Status</th>
		...
		<tr>
		    <td><?= $numb; ?></td>
			<td><?= $record->nama ?></td>
			<td><?= $record->code_category_marketplace ?></td>
			<td>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-id_inventory1="<?=$record->id?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
...
<div class="modal modal-default fade" id="dialog-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="myModalLabel"><span class="fa fa-users"></span>&nbsp;Data Kategori Produk</h4>
      </div>
