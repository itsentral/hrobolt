		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="form-group row">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" id="" required name="kode_sku" placeholder="Kode SKU Type" value="<?= $inven->sku_code ?>">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-3">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" id="" required name="kode_kategory_marketplace" placeholder="Kode Kategori Marketplace Type" value="<?= $inven->code_category_marketplace ?>">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-3">
