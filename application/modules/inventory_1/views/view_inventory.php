...
<div class="box box-solid">	
	...
	<div class="box-body">
		<div class="box-body">	
			<div class="row">
			  <div class="col-md-12">
				<legend><h3 style="margin:0px !Important"><label>Nama Kategori Produk : <?= $result['nama']?></label></h3></legend>
				<legend><h3 style="margin:0px !Important"><label>SKU Kode Kategori Produk : <?= $result['sku_code']?></label></h3></legend>
				<legend><h3 style="margin:0px !Important"><label>Kode Kategori Marketplace : <?= $result['code_category_marketplace']?></label></h3></legend>
			  <div>
			</div>
		</div>
	</div>
