<?php
$ENABLE_ADD     = has_permission('Approval_Stock_Cost_Control.Add');
$ENABLE_MANAGE  = has_permission('Approval_Stock_Cost_Control.Manage');
$ENABLE_VIEW    = has_permission('Approval_Stock_Cost_Control.View');
$ENABLE_DELETE  = has_permission('Approval_Stock_Cost_Control.Delete');
?>
<style type="text/css">
    thead input {
        width: 100%;
