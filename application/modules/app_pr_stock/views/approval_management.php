<?php
$ENABLE_ADD     = has_permission('Approval_Stock_Management.Add');
$ENABLE_MANAGE  = has_permission('Approval_Stock_Management.Manage');
$ENABLE_VIEW    = has_permission('Approval_Stock_Management.View');
$ENABLE_DELETE  = has_permission('Approval_Stock_Management.Delete');
?>
<style type="text/css">
    thead input {
        width: 100%;
