...
class App_pr_stock extends Admin_Controller
{
  ...
  protected $viewPermission1   = 'Approval_Stock_Head.View';
  protected $addPermission1    = 'Approval_Stock_Head.Add';
  protected $managePermission1 = 'Approval_Stock_Head.Manage';
  protected $deletePermission1 = 'Approval_Stock_Head.Delete';

  protected $viewPermission2   = 'Approval_Stock_Cost_Control.View';
  protected $addPermission2    = 'Approval_Stock_Cost_Control.Add';
  protected $managePermission2 = 'Approval_Stock_Cost_Control.Manage';
  protected $deletePermission2 = 'Approval_Stock_Cost_Control.Delete';

  protected $viewPermission3   = 'Approval_Stock_Management.View';
  protected $addPermission3    = 'Approval_Stock_Management.Add';
  protected $managePermission3 = 'Approval_Stock_Management.Manage';
  protected $deletePermission3 = 'Approval_Stock_Management.Delete';
  ...
  public function detail_planning($so_number = null, $page)
  {
    $header     = $this->db
      ->select('a.*, b.due_date, c.nm_customer')
      ->join('so_internal b', 'a.so_number=b.so_number', 'left')
