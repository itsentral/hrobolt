...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td><?= $record->qty ?><?= $bentuk[0]->namabentuk ?></td>
			<td><?= $record->totalweight ?> Kg</td>
		...
		<tr>
			...
			<td><?= $jumlah[0]->jumlahweight ?> Kg</td>
			<td><?= $jumlah[0]->jumlahqty ?> <?= $bentuk[0]->namabentuk ?></td>
			<td><?= $jumlah[0]->jumlahtotalweight ?> Kg</td>
			<td colspan="2"></td>
		</tr>
		</thead>
		</table>
