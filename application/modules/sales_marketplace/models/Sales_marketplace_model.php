...
class Sales_marketplace_model extends BF_Model
{

    /**
     * @var string  User Table Name
     */
    protected $table_name = 'sales_marketplace_header';
    protected $key        = 'id';
    ...
    {
        $date = date('ymdhis');
        $getCode = $this->db->query("SELECT MAX(SUBSTR(code_order,13,3)) code FROM sales_marketplace_header ORDER BY code_order DESC  LIMIT 1")->row();
        $num = $getCode->code + 1;
