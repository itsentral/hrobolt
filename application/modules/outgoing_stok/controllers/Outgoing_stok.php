...
{
  //Permission
  protected $viewPermission   = 'Outgoing_Indirect.View';
  protected $addPermission    = 'Outgoing_Indirect.Add';
  protected $managePermission = 'Outgoing_Indirect.Manage';
  protected $deletePermission = 'Outgoing_Indirect.Delete';
