<?php
    $ENABLE_ADD     = has_permission('Outgoing_Indirect.Add');
    $ENABLE_MANAGE  = has_permission('Outgoing_Indirect.Manage');
    $ENABLE_VIEW    = has_permission('Outgoing_Indirect.View');
    $ENABLE_DELETE  = has_permission('Outgoing_Indirect.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
