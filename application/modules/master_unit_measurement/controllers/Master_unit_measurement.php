 ...
 *
 */
class Master_unit_measurement extends Admin_Controller
{
    //Permission
    protected $viewPermission 	= 'Unit_Measurements.View';
    protected $addPermission  	= 'Unit_Measurements.Add';
    protected $managePermission = 'Unit_Measurements.Manage';
    protected $deletePermission = 'Unit_Measurements.Delete';
