<?php
    $ENABLE_ADD     = has_permission('Unit_Measurements.Add');
    $ENABLE_MANAGE  = has_permission('Unit_Measurements.Manage');
    $ENABLE_VIEW    = has_permission('Unit_Measurements.View');
    $ENABLE_DELETE  = has_permission('Unit_Measurements.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
