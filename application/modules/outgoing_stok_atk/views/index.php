<?php
$ENABLE_ADD     = has_permission('Outgoing_ATK_Household.Add');
$ENABLE_MANAGE  = has_permission('Outgoing_ATK_Household.Manage');
$ENABLE_VIEW    = has_permission('Outgoing_ATK_Household.View');
$ENABLE_DELETE  = has_permission('Outgoing_ATK_Household.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
