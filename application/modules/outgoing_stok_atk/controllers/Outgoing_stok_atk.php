...
{
  //Permission
  protected $viewPermission   = 'Outgoing_ATK_Household.View';
  protected $addPermission    = 'Outgoing_ATK_Household.Add';
  protected $managePermission = 'Outgoing_ATK_Household.Manage';
  protected $deletePermission = 'Outgoing_ATK_Household.Delete';
