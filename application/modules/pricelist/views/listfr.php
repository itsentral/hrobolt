...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td>Rp. 
			<?= number_format($record->bottom_price) ?>
			</td>
			<td style="padding-left:20px">
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-id_pricelistfr="<?=$record->id_pricelistfr?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-sm edit" href="javascript:void(0)" title="Edit" data-id_pricelistfr="<?=$record->id_pricelistfr?>"><i class="fa fa-edit"></i>
				</a>
			<?php endif; ?>
			</td>
...
<script type="text/javascript">
	...
	$(document).on('click', '.edit', function(e){
		var id = $(this).data('id_pricelistfr');
		$("#head_title").html("<i class='fa fa-list-alt'></i><b>Edit Pricelist</b>");
		$.ajax({
			type:'POST',
			url:siteurl+'pricelist/editPricelistfr/'+id,
			data:{'id':id},
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'pricelist/viewPricelistfr/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
		...
		$.ajax({
			type:'POST',
			url:siteurl+'pricelist/addPricelistfr/'+id_category1,
		...
		$.ajax({
			type:'POST',
			url:siteurl+'pricelist/refPricelistfr/'+id_category1,
			data:{'id_category1':id_category1},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
