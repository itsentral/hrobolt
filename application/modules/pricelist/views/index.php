...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
		    <td><?= $numb; ?></td>
			<td hidden><?= $record->id_category1?></td>
			<td><?= $record->nama ?></td>
			<td style="padding-left:20px">
			
			<?php if($record->id_category1 == "I2000001") : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/pricelist/detailfr/'.$record->id_category1) ?>" title="Detail" data-id_category1="<?=$record->id_category1?>"><i class="fa fa-table"></i>
				</a>
			<?php elseif($record->id_category1 == "I2000002") : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/pricelist/detailnfr/'.$record->id_category1) ?>" title="Detail" data-id_category1="<?=$record->id_category1?>"><i class="fa fa-table"></i>
				</a>
			<?php endif; ?>
			</td>
