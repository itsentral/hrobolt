<?php
	...
	foreach($results['pl'] as $pricelist){}
		$bookprice	= $this->db->query("SELECT * FROM ms_bookprice_material WHERE id_category3 = '$pricelist->id_category3' ")->result();
 ...
 <div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						<div class="input_fields_wrap2">
							...
							<div class="row">
									    ...
									    <div class="col-md-6">
					<select id="id_category3" name="id_category3" readonly class="form-control select"  required>
					...
					<input type="text" class="form-control" id="book_price"  required name="book_price" value="<?=$nilai?>" placeholder="Book Price (Rp/kg)">
									    </div>
										</div>
						 </div>
						 <div class="row">
					...
					<div class="row">
									    ...
									    <div class="col-md-6">
					<input type="text" class="form-control" id="profit" value="<?=$pricelist->profit?>"  required name="profit" onkeyup="hitungbottom()" placeholder="Profit (%)">
									    </div>
										</div>
						 </div>
					<div class="row">
					...
					<input type="text" class="form-control" id="bottom_price" value="<?=$pricelist->bottom_price?>" required name="bottom_price" placeholder="Bottom price (Rp/kg)">
									    </div>
										</div>
						 </div>
						</div>
