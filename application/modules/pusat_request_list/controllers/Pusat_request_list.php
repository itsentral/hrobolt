...
{
  //Permission
  protected $viewPermission   = 'Gudang_Pusat_Outgoing.View';
  protected $addPermission    = 'Gudang_Pusat_Outgoing.Add';
  protected $managePermission = 'Gudang_Pusat_Outgoing.Manage';
  protected $deletePermission = 'Gudang_Pusat_Outgoing.Delete';
  ...
  public function modal_request_edit()
  {
    if ($this->input->post()) {
      ...
      if ($this->db->trans_status() === FALSE || $valid_qty_lot < 1) {
