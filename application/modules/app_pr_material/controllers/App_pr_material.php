...
class App_pr_material extends Admin_Controller
{
  ...
  protected $viewPermission1   = 'Approval_Material_Department_Head.View';
  protected $addPermission1    = 'Approval_Material_Department_Head.Add';
  protected $managePermission1 = 'Approval_Material_Department_Head.Manage';
  protected $deletePermission1 = 'Approval_Material_Department_Head.Delete';

  protected $viewPermission2   = 'Approval_Material_Cost_Control.View';
  protected $addPermission2    = 'Approval_Material_Cost_Control.Add';
  protected $managePermission2 = 'Approval_Material_Cost_Control.Manage';
  protected $deletePermission2 = 'Approval_Material_Cost_Control.Delete';

  protected $viewPermission3   = 'Approval_Material_Management.View';
  protected $addPermission3    = 'Approval_Material_Management.Add';
  protected $managePermission3 = 'Approval_Material_Management.Manage';
  protected $deletePermission3 = 'Approval_Material_Management.Delete';
