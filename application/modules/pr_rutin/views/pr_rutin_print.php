	...
	<table width="1000" cellspacing="0" cellpadding="2">
		...
		if(!empty($data_material)){
			...
			foreach($data_material AS $record){
				$idd++;$total=$total+($record->element_cost*$record->material_order);?>
			<tr>
				...
				<td class="border-all" valign=top align="right"><?= number_format($record->element_cost);?></td>
				<td class="border-all" valign=top align="right"><?= number_format($record->element_cost*$record->material_order);?></td>
			</tr>
			<?php 
			}
		}?>
		...
		<tr>
			...
			<td colspan=4 align="center">Menyetujui<br /><br /><br /><br /><br /><br /><br />Imanuel Iman</td>
		</tr>
		</tbody>
	</table>
</body>
