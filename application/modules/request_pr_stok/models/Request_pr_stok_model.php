  ...
  public function data_side_approval_pr_material()
  {
    ...
    foreach ($query->result_array() as $row) {
      ...
      foreach ($get_detail_pr as $item) {
        ...
        $this->db->select('a.stock_name, a.konversi, b.code');
        ...
        if (!empty($get_stok_data)) {
          ...
          $qty_detail = $qty_detail . number_format($item->propose_purchase * $get_stok_data->konversi, 2).' '.ucfirst($get_stok_data->code).'<br>';
        }
      }
