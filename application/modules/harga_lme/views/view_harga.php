		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="hd1[1][nm_inventory]" readonly value="<?= $nama_user->nm_lengkap ?>" placeholder="Nama Inventory">
									    </div>
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="hd1[1][nm_inventory]" value="<?= $tanggal ?>" placeholder="Nama Inventory">
									    </div>
										</div>
									...
									<table class='table table-bordered table-striped'>
										...
										<tbody id='list_payment'>
											...
											<tr>
												...
												<td>
													<input type='text' class="form-control" readonly value='<?= $harga->name_compotition ?>'>
												</td>
												<td>
													<input type='text' class="form-control" readonly value='<?= $harga->harga ?>'>
												</td>
											</tr>
											<?php
											}	
