						   ...
						   <div class="input_fields_wrap2">
								...
								<div class="row">
									...
									<table class='table table-bordered table-striped'>
										<thead>
											<tr class='bg-blue'>
												<td align='center' hidden><b>Id Komposisi</b></td>	
									...
									echo"<tr id='tr_".$loop."'>";
									       echo"<td hidden>";
										   echo form_input(array('name'=>'data9['.$loop.'][idcompotition]','id'=>'data9_'.$loop.'_idcompotition','class'=>'form-control input-sm','autocomplete'=>'off'),$harga->id_compotition);
										   echo"</td>";
											echo"<td>";
											echo form_input(array('name'=>'data9['.$loop.'][nmcompotition]','readonly'=>'1','id'=>'data9_'.$loop.'_nmcompotition','class'=>'form-control input-sm','autocomplete'=>'off'),$harga->name_compotition);											
											echo"</td>";
											echo"<td>";
											echo form_input(array('name'=>'data9['.$loop.'][harga]','id'=>'data9_'.$loop.'_harga','class'=>'form-control input-sm','autocomplete'=>'off'),$harga->harga);										
											echo"</td>";
									echo"</tr>";
