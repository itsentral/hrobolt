...
class Material_model extends BF_Model
{
     ...
     */
    protected $table_name = 'ms_material_konversi';
    protected $key        = 'id';
    ...
    function getById($id)
    {
	 ...
	 public function get_data_material_konversi(){
		$this->db->select('a.*, b.nama as nama_material');
		$this->db->from('ms_material_konversi a');
		$this->db->join('ms_material b','b.id_material=a.id_material',right);
