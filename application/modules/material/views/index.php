<div id='tampil'>
<?php
    $ENABLE_ADD     = has_permission('Konversi_Material.Add');
    $ENABLE_MANAGE  = has_permission('Konversi_Material.Manage');
    $ENABLE_VIEW    = has_permission('Konversi_Material.View');
    $ENABLE_DELETE  = has_permission('Konversi_Material.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<div class="box">
	<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
					<a class="btn btn-success btn-sm" href="<?= base_url('material/addKonversi') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
