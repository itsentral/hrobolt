<?php
    $ENABLE_ADD     = has_permission('Approval.Add');
    $ENABLE_MANAGE  = has_permission('Approval.Manage');
    $ENABLE_VIEW    = has_permission('Approval.View');
    $ENABLE_DELETE  = has_permission('Approval.Delete');
...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('/penawaran/prosesapproval/'.$record->no_penawaran) ?>" title="Lakukan Approval"><i class="fa fa-mail-forward"></i>
				</a>
			<?php endif; ?>
