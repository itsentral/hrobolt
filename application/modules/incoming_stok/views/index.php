<?php
$ENABLE_ADD     = has_permission('Incoming_Stock.Add');
$ENABLE_MANAGE  = has_permission('Incoming_Stock.Manage');
$ENABLE_VIEW    = has_permission('Incoming_Stock.View');
$ENABLE_DELETE  = has_permission('Incoming_Stock.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
