...
<table class='gridtable' border="1" width='100%' align="center" cellpadding="2" cellspacing="0">
    ...
    foreach($detail as $detail){
        ...
        $stock 		    = $this->db->get_where('stock_material', array('lotno'=>$detail->lotno))->result();
		
		$spec = floatval($detail->thickness).' x '.floatval($detail->width).' x '.$coil;
        ?>
        <tr>
            <td width="8" align="center" ><?= $no ?></td>
            <td width="110"><?=$detail->nm_material ?></td>
            <td width="55"><?= $spec ?></td>
            <td width="115" align="left"><?= $detail->lotno ?></td>
            <td width="40" align="center"></td>
            <td width="20" align="center"><?= number_format($detail->qty_mat,0);?></td>
...
<tr>
        ...
        <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="40" ></th>
