		...
		<div class="box box-primary">
			<div class="box-body">
				<div class="form-group ">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input type="date" class="form-control" id="tanggal_doc" name="tanggal_doc" value="<?php echo (isset($data->tanggal_doc) ? $data->tanggal_doc: date("Y-m-d")); ?>" placeholder="Tanggal" required>
						</div>
					</div>
