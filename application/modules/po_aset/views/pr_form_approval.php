                ...
                <div class="box-body">
					<div class="form-group ">
						...
						<div class="col-sm-3">
							<div class="input-group">
								...
								<input type="text" class="form-control tgl" id="tgl_pr" name="tgl_pr" value="<?php echo set_value('tgl_pr', isset($data->tgl_pr) ? $data->tgl_pr: date("Y-m-d")); ?>" placeholder="Automatic" readonly >
							</div>
						</div>
					</div>
					<div class="form-group ">
						...
						<div class="col-sm-3">
								...
								echo form_dropdown('id_aset',$dataaset, set_value('id_aset', isset($data->id_aset) ? $data->id_aset: '0'), array('id'=>'id_aset','class'=>'form-control readonly select2','required'=>'required', 'onchange'=>'get_budget()'));
								?>
						</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-3">
							<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<input type="text" class="form-control divide" id="nilai_pr" name="nilai_pr" value="<?php echo isset($data->nilai_pr) ? $data->nilai_pr: 0; ?>" readonly>
							</div>
						</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-3">
							...
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<?php
							echo form_dropdown('ppn',$datppn, (isset($data->ppn) ? $data->ppn: 0), array('id'=>'ppn','class'=>'form-control select2 readonly','required'=>'required','onchange'=>'cekppn()'));
							?>
							</div>
						</div>
...
<script type="text/javascript">
	$("#frm_data").attr("readonly", "readonly");
