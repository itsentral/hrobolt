                ...
                <div class="box-body">
					...
					<div class="form-group ">
							...
							<div class="col-sm-3">
								...
								<?php 
								if(isset($datarpo)){
								if ($datarpo->tipe_bayar == 1 && $datarpo->approve_now == 5) {?>							
								<div class="input-group">
									<?php
									$datcoa[0]	= 'Select Coa Uang Muka';
									echo form_dropdown('uang_muka',$datcoa,'0', array('id'=>'uang_muka','class'=>'form-control select2'));
									?>
								</div>							
							  <?php }
								}?>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
    ...
    $('#frm_data').on('submit', function(e){
		...
		// if(tipe_bayar==1 && uangmuka==0){
			// alert("Silahkan Pilih Coa Uang Muka Terlebih Dahulu");
			// return false
		// }
