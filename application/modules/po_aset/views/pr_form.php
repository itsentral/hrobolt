					...
					<div class="form-group ">
						...
						<div class="form-group ">
							...
							<div class="col-sm-3">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-list"></i></span>
									<input type="text" class="form-control" id="qty_inspect" name="qty_inspect" onkeyup="terima()" value="<?php echo set_value('qty_inspect', isset($data->qty_inspect) ? $data->qty_inspect: ''); ?>">
								</div>
							</div>
						</div>
						<div class="form-group ">
...
//			echo '$("#frm_data :input").attr("readonly", true);';
    ...
    $('#frm_data').on('submit', function(e){
		...
		if(($("#tipe_pr").val()=="PP")){
		  if($("#qty_inspect").val()=="")	d_error=' Kesesuaian Qty Harus Diisi!!';
		}
		if(d_error!=''){
			alert(d_error);
		}else{
