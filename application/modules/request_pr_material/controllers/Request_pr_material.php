...
class Request_pr_material extends Admin_Controller
{
  ...
  public function index()
  {
    ...
    $sql = "SELECT
            ...
            WHERE 1=1 AND a.category in ('pr material','base on production') AND a.booking_date IS NOT NULL";
  ...
  public function set_update_propose_reorder()
  {
    ...
    $get_materials   = $this->db
      ...
      ->result_array();
      // return $this->output->set_status_header(200)->set_content_type('application/json')->set_output(json_encode($get_materials));
