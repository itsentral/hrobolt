...
// print_r($id_bq);
// exit;
$data_header        = $this->db->query("SELECT * FROM tr_debit_note_payment WHERE kd_pembayaran ='$kodebayar'")->row();
$data_detail        = $this->db->query("SELECT sum(total_bayar_idr) as total_bayar FROM tr_debit_note_payment_detail WHERE kd_pembayaran ='$kodebayar'")->row();
        ...
        <div class="tab-pane active" id="salesorder">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                   ...
                   <div class="col-sm-6 form-horizontal">                       
					    <div class="form-group ">
                            <label for="idsalesman" class="col-sm-4 control-label">Total DN Bayar</label>
                            <div class="col-sm-6" style="padding-top: 8px;">
						...
						<form id="form-detail-mutasi" method="post">
							<table class="table table-bordered" width="100%" id="tabel-detail-mutasi">
								...
								<?php
									...
									$detail        = $this->db->query("SELECT * FROM tr_debit_note_payment_detail WHERE kd_pembayaran ='$kodebayar'")->result();
									...
									$inv_det  = $this->db->query("SELECT * FROM tr_debit_note WHERE no_pr ='$kodeinv'")->row();
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><?php echo  number_format($inv_det->total_tagihan,2)?></td>
										<td class="text-center"><?php echo  number_format($inv_det->sisa_tagihan,2)?></td>
