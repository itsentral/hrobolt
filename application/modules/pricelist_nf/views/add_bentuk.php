		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
										...
										<div class="col-md-4">
									    <label for="customer">Nama Bentuk</label>
									    </div>
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="hd1[1][nm_bentuk]" placeholder="Nama Bentuk">
									    </div>
										</div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_bentuk/saveNewbentuk';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
