 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-8">
				<input type="text" class="form-control" disabled id="nama_bentuk"  value ="Roll" required name="nama_bentuk" readonly placeholder="No.CRCL">
			</div>
		</div>
		</div>
		<div class="col-sm-6">
		<div class="form-group row">
			...
			<div class="col-md-8">
				<select id="id_category3" name="id_category3" disabled class="form-control select" onchange="caridensity()"  required>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="number" class="form-control" disabled id="thickness" value ="<?= $ink->thickness ?>" readonly required name="thickness">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="number" class="form-control" disabled id="density" value ="<?= $ink->density ?>" readonly required name="density">
				</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="number" class="form-control"disabled id="width" value ="<?= $ink->dimensi1 ?>"  required  name="width" onkeyup="hitungmasa()">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-4">
				<input type="number" class="form-control" disabled id="berat_produk" value ="<?= $ink->berat_produk_max ?>" required  name="berat_produk" onkeyup="hitungmasa()">
				</div>
				<div class="col-md-4">
				<input type="number" class="form-control" disabled id="berat_produk_max" value ="<?= $ink->berat_produk ?>" required  name="berat_produk_max" onkeyup="hitungmasa()">
				</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row" id="tempat_berat">
				...
				<div class="col-md-8">
				<input type="number" class="form-control" disabled id="panjang" value ="<?= $ink->dimensi2 ?>"  readonly required name="panjang">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-4">
				<input type="text" class="form-control" disabled value ="<?= $ink->toleransi1max ?>"  id="toleransi1max" required name="toleransi1max" placeholder="Max">
				</div>
				<div class="col-md-4">
				<input type="text" class="form-control" disabled value ="<?= $ink->toleransi1min ?>"  id="toleransi1min" required name="toleransi1min" placeholder="Min">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			...
			<div class="col-md-4">
				...
				<div class="col-md-4">
				<input type="text" class="form-control" disabled value ="<?= $ink->toleransi2max ?>" id="toleransi2max" required name="toleransi2max"placeholder="Max" >
				</div>
				<div class="col-md-4">
				<input type="text" class="form-control" disabled value ="<?= $ink->toleransi2min ?>" id="toleransi2min" required name="toleransi2min"placeholder="Min" >
				</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="text" class="form-control" disabled value ="<?= $ink->burry ?>" id="burry" required name="burry" >
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			...
			<div class="col-md-4">
				...
				<div class="col-md-8">
				<select id="sambungan" disabled name="sambungan" class="form-control select"  required>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="text" class="form-control" disabled value ="<?= $ink->apperance ?>"  id="apperance" required name="apperance" placeholder="Max">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			...
			<div class="col-md-4">
				...
				<div class="col-md-8">
				<input type="text" class="form-control" disabled value ="<?= $ink->maxjoin ?>"  id="maxjoin" required name="maxjoin" >
				</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			...
			<div class="col-md-4">
				...
				<div class="col-md-8">
				<select id="labels" disabled name="labels" class="form-control select"  required>
		...
		<div class='form-group row'>
			<center>
		<a class="btn btn-success btn-sm" href="<?= base_url('/transaksi_inquiry/PrintRoll/'.$ink->id_dt_inquery) ?>" target="_blank" title="Edit">Cetak</a>
			</center>
				 </div>
			</div>
			</div>
