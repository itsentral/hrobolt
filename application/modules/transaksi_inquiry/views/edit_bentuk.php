    ...
    <div class="box-body">
		<form id="data-form" method="post">
						   ...
						   <div class="input_fields_wrap2">
									    ...
									    <label for="customer">Inventory Name</label>
										 ...
										 <div class="col-md-6" hidden>
											<input type="text" class="form-control" id="" required name="hd1[1][id_bentuk]" value="<?= $bentuk->id_bentuk ?>" placeholder="Nama Inventory">
									    </div>
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="hd1[1][nm_bentuk]" value="<?= $bentuk->nm_bentuk ?>" placeholder="Nama Inventory">
									    </div>
										</div>
									...
									<table class='table table-bordered table-striped'>
										<thead>
											<tr class='bg-blue'>
												...
												<td align='center'><b>Nama Dimensi</b></td>	
					...
					<input type="text" class="form-control input-sm" name="data2['<?= $numb ?>'][id_dimensi]" value="<?= $dimensi->id_dimensi ?>" id="data2_'<?= $numb ?>'_id_dimensi" label="FALSE" div="FALSE">
												...
												<td align="left">
					<select class="form-control input-sm" name="data1['<?= $numb ?>'][nm_dimensi]" id="data1_'<?= $numb ?>'_nm_dimensi" label="FALSE" div="FALSE">
						<option value="<?= $dimensi->nm_dimensi ?>"><?= $dimensi->nm_dimensi ?></option>
						...
						<option value="SISI-1">SISI-1</option>
						<option value="SISI-2">SISI-2</option>
	...
	$(document).ready(function(){
		...
		$('#add-payment').click(function(){
			...
			Template	+='<td align="left">';
					Template	+='<select class="form-control input-sm" name="data1['+loop+'][nm_dimensi]" id="data1_'+loop+'_nm_dimensi" label="FALSE" div="FALSE">';
						Template	+='<option value="">--Pilih--</option>';
						Template	+='<option value="HARDNESS">HARDNESS</option>';
						Template	+='<option value="THICKNESS">THICKNESS</option>';
						Template	+='<option value="COIL">COIL</option>';
						Template	+='<option value="WIDTH">WIDTH</option>';
						Template	+='<option value="LENGTH">LENGTH</option>';
						Template	+='<option value="DIAMETER">DIAMETER</option>';
						Template	+='<option value="SISI">SISI</option>';
						Template	+='<option value="SISI-1">SISI-1</option>';
						Template	+='<option value="SISI-2">SISI-2</option>';
						Template	+='<option value="OD">OD</option>';
