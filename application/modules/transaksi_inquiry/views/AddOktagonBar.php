    ...
    <div class="box-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-8" hidden>
				...
				<input type="text" class="form-control" id="id_bentuk"  value ="B2000006" required name="id_bentuk" readonly placeholder="No.CRCL">
			</div>
			<div class="col-md-8">
				<input type="text" class="form-control" id="nama_bentuk"  value ="Oktagon Bar" required name="nama_bentuk" readonly placeholder="No.CRCL">
			</div>
		</div>
		</div>
		<div class="col-sm-6">
