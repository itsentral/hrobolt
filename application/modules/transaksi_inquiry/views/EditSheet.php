    ...
    <div class="box-body"> 
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="number" class="form-control" id="width" required value="<?= $ink->dimensi1?>"  name="width" onkeyup="hitungmasa()">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
				...
				<div class="col-md-8">
				<input type="number" class="form-control" id="panjang" value="<?= $ink->dimensi2?>" required name="panjang"  onkeyup="hitungmasa()">
				</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row" id="tempat_berat">
				...
				<div class="col-md-4">
				<input type="number" class="form-control" id="berat_produk" value="<?= $ink->berat_produk?>" required  name="berat_produk">
				</div>
				<div class="col-md-4">
				<input type="number" class="form-control" id="berat_produk_max" value="<?= $ink->berat_produk_max?>" required  name="berat_produk_max">
				</div>
			</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-4">
				<input type="text" class="form-control" id="toleransi1min" value="<?= $ink->toleransi1min?>"  required name="toleransi1min" placeholder="Min">
				</div>
				<div class="col-md-4">
				<input type="text" class="form-control" id="toleransi1max" value="<?= $ink->toleransi1max?>"  required name="toleransi1max" placeholder="Max">
				</div>
		...
		<div class="col-sm-6">
			...
			<div class="col-md-4">
				...
				<div class="col-md-4">
				<input type="text" class="form-control" id="toleransi2min" value="<?= $ink->toleransi2min?>"  required name="toleransi2min"placeholder="Min" >
				</div>
				<div class="col-md-4">
				<input type="text" class="form-control" id="toleransi2max" value="<?= $ink->toleransi2max?>"  required name="toleransi2max"placeholder="Max" >
				</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="text" class="form-control" id="burry" value="<?= $ink->burry?>"  required name="burry" >
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="text" class="form-control" id="apperance" value="<?= $ink->apperance?>"  required name="apperance" placeholder="Max">
				</div>
			</div>
		</div>
		</div>
