 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<tr>
			...
			<td><?= $detail->nilai ?></td>
			<td><?= $detail->width ?></td>
			<td>$ <?= number_format($detail->harga_penawaran/14500,2) ?></td>
		...
		<tr>
			...
			<td rowspan='2'><center><?= $header->pic_customer ?>,<?= $header->name_customer ?></center></td>
			<td rowspan='2'><center>Exclude vat <?= $header->exclude_vat ?> %</center></td>
			</tr>
			<tr>
			<td><center><?= $header->valid_until ?></center></td>
			<td><center><?= $header->terms_payment ?> Bulan</center></td>
			</tr>
			</table>
			</td>
		</tr>		
