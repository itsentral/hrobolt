...
class Master_top extends Admin_Controller
{

	protected $viewPermission   = "Terms_of_Payment.View";
	protected $addPermission    = "Terms_of_Payment.Add";
	protected $managePermission = "Terms_of_Payment.Manage";
	protected $deletePermission = "Terms_of_Payment.Delete";
