<?php
$ENABLE_ADD     = has_permission('Terms_of_Payment.Add');
$ENABLE_MANAGE  = has_permission('Terms_of_Payment.Manage');
$ENABLE_VIEW    = has_permission('Terms_of_Payment.View');
$ENABLE_DELETE  = has_permission('Terms_of_Payment.Delete');
?>
