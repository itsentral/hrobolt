    ...
    <div class="box-body">
				...
				<div class="input_fields_wrap2">	
					<div class="row">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="" required name="hd1[1][nm_inventory]" placeholder="Nama Brand Produk">
							</div>
						</div>

						<div class="form-group row">
							<div class="col-md-4">
								<label for="customer">Kode SKU</label>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="" required name="hd1[1][kode_sku]" placeholder="Masukan Kode SKU">
								<!-- <small>Pastikan Kode SKU, merupakan data yang tidak di generate automatis dari Sistem. Jika iya, Maka kosongkan saja.</small>
								<small>Kode SKU merupakan data decimal dari Table ASCII</small> -->
							</div>
							<!-- <div class="col-md-2">
								<button class="btn btn-success" id="btn-ascii" type="button">Lihat ASCII Table</button>
							</div> -->
						</div>

						<!-- <div class="form-group row" id="ascii-frame" style="display: none;">
							<div class="col-md-12">
								<small>Data Decimal Abjad merupakan dibagian paling kiri</small>
								<center>
									<img src="<?php echo base_url('assets/'); ?>images/ascii table.png" />
								</center>
							</div>
						</div> -->
		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-8 col-xs-8">
				<button type="submit" class="btn btn-success btn-sm col-md-12 col-sm-12 col-xs-12" name="save" id="simpan-com"><i class="fa fa-save"></i> Simpan</button>
			</div>
			<div class="col-md-2 col-sm-2 col-xs-2">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#btn-ascii').click(function() {
			var elem = document.getElementById("btn-ascii");
			var elemframe = document.getElementById("ascii-frame");
			if (elemframe.style.display === 'none') {
				elemframe.style.display = 'block';
				elem.innerText = 'Tutup ASCII Table';
			} else {
				elemframe.style.display = 'none';
				elem.innerText = 'Lihat ASCII Table';
			}
		});
