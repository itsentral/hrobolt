				...
				<div class="input_fields_wrap2">
					<div class="row">
						<div class="form-group row">
							<div class="col-md-4">
								<label for="customer">Nama Kategori Produk</label>
							</div>
							<div class="col-md-6">
								<select id="inventory_1" name="hd1[1][inventory_1]" class="form-control select" required>
									<option value="">-- Inventory --</option>
									<?php foreach ($results['lvl1'] as $lvl1){
									$select = $results['inven']->id_type == $lvl1->id ? 'selected' : '';
									?>
									<option value="<?= $lvl1->id?>" <?= $select ?>><?= $lvl1->nama?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
								<label for="customer">Nama Brand</label>
							</div>
							<div class="col-md-6" hidden>
								<input type="text" class="form-control" id="" required name="hd1[1][id_inventory]" value="<?= $results['inven']->id ?>" placeholder="Nama Inventory">
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="" required name="hd1[1][nm_inventory]" value="<?= $results['inven']->nama ?>" placeholder="Nama Inventory">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
								<label for="customer">SKU Code</label>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="" required name="hd1[1][sku_code]" value="<?= $results['inven']->sku_code ?>" placeholder="Nama Inventory">
							</div>
						</div>
						...
						<table class='table table-bordered table-striped'>
							...
							?>
								<tr id="tr_'<?= $numb ?>'">
									...
									<td align="center">
										<a class="btn btn-danger btn-sm delete" href="javascript:void(0)" title="Delete" data-id_compotition="<?=$komposisi->id_compotition?>"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
							<?php $numb++;
							}	
