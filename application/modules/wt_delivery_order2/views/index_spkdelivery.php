...
<div class="box">
		<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('/wt_delivery_order/addSpkdelivery/') ?>"  title="Add New"><i class="fa fa-plus">&nbsp;</i>Add</i></a>
			<?php endif; ?>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				<?php if($record->status_do !='1') : ?>
                <!--<a class="btn btn-primary btn-sm" href="<?= base_url('/wt_delivery_order/Editspkdelivery/'.$record->no_spk) ?>" title="Edit Spk Delivery" ><i class="fa fa-pencil"></i>
				</a>-->
