<?php
    $ENABLE_ADD     = has_permission('Outgoing_Sparepart.Add');
    $ENABLE_MANAGE  = has_permission('Outgoing_Sparepart.Manage');
    $ENABLE_VIEW    = has_permission('Outgoing_Sparepart.View');
    $ENABLE_DELETE  = has_permission('Outgoing_Sparepart.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
