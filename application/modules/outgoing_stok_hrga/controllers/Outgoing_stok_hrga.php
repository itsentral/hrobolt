...
{
  //Permission
  protected $viewPermission   = 'Outgoing_Sparepart.View';
  protected $addPermission    = 'Outgoing_Sparepart.Add';
  protected $managePermission = 'Outgoing_Sparepart.Manage';
  protected $deletePermission = 'Outgoing_Sparepart.Delete';
