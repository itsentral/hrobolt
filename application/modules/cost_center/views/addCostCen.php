				...
				<div class="row">
							...
							<div class="col-md-4">
							 ...
							 <div class="col-md-8">
							   <select id="id_department" name="id_department" class="form-control select" onchange="carinama()" required>
											...
											?>
											<option value="<?= $department->id?>"><?= ucfirst(strtolower($department->nm_dept))?></option>
											<?php } ?>
										  </select>
							</div>
						</div>
					...
					<div class="col-md-12">
							...
							<div class="col-md-4">
							 ...
							 <div class="col-md-8">
							  <input type="text" class="form-control" id="cost_center" required name="cost_center" placeholder="Cost Center">
							</div>
						</div>	
					</div>
			<div class="col-md-3">
  ...
  $(document).ready(function() {
    ...
    $(document).on('submit', '#data_form', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'cost_center/saveNewCostCen',
			  dataType : "json",
			  data:data,
