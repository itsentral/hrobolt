		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
					 <input type="text" class="form-control" id="no_surat" required name="no_surat" value=<?= $hd->no_surat ?> readonly placeholder="No Surat" tabindex='-1'>                    
			...
			<div class="col-sm-12">
				<div class="form-group row" >
                  ...
                  foreach(@$getitemso as $kdo => $dt_spk){
                      ...
                      $cust    = $this->db->query("SELECT * FROM master_customers WHERE id_customer ='$hd->id_customer' ")->row();
