...
$employeeId		    = (!empty($header[0]->id))?$header[0]->employee_id:'';
$role	    	    = (!empty($header[0]->id))?$header[0]->role:'';
	...
	<div class="box box-primary">
		...
		<div class="box-body">
            <div class="box box-warning">
                ...
                <div class='form-group row'>		 	 
                    <label class='label-control col-sm-2'><b>User Account</b></label>
                    <div class='col-sm-4'>
                        <select name='user' id='user' class='form-control input-md'>
                            <option value='0'>Select Your Account User</option>
							<?php
							foreach($users AS $val => $valx){
								$selected = ($valx['employee_id'] == $employeeId)?'selected':'';
								echo "<option value='".$valx['id_user']."' ".$selected.">".$valx['username']." | " . $valx['nm_lengkap'] . "</option>";
							}
							?>
                        </select>
                    </div>
                    <label class='label-control col-sm-2'><b>Role</b></label>
                    <div class='col-sm-4'>
                        <select name='role' id='role' class='form-control input-md'>
                            <option value="">Pilih Role Anda</option>
							<option value="Marketing Manager" <?= ($role == 'Marketing Manager') ? 'selected' : '' ?>>Marketing Manager</option>
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    <div class='form-group row'>		 	 
                        ...
                        <div class='col-sm-4'>             
                            <?php
                                echo form_input(array('id'=>'tgl_end','name'=>'tgl_end','class'=>'form-control input-md datepicker2','readonly'=>'readonly','placeholder'=>'End Date'),$tgl_end);											
                            ?>
                        </div>
                    </div>
                    <div class='form-group row'>		 	 
