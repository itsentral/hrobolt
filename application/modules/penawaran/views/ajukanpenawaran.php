		...
		<div class="col-sm-12">
            <div class="col-sm-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select id="id_customer" name="id_customer" class="form-control select" onchange="get_customer()" required readonly>
		    ...
		    <div class='col-sm-6'>
			    <div class='form-group row'>
				    ...
				    <div class='col-md-8' id="pic_slot" >
						<input type="text" class="form-control" id='pic_customer' name='pic_customer' value="<?= strtoupper($hd->pic_customer) ?>" readonly>
				    </div>
			    </div>
		    </div>
		</div>		
                                            ...
                                            <td>
                                                <select id='used_no_surat_$loop' name='dt[$loop][no_surat]' data-no='$loop' onchange='CariDetail($loop)' class='form-control select' readonly required>
                                                    ...
                                                    foreach($material as $produk){
                                                        ...
                                                        echo"<option value='$produk->id_product' $select>$produk->nama|$produk->sku_varian</option>";
                                                    }
                                        echo	"</select>
                                            </td>
                                            ...
                                            <td id='qty_$loop'><input type='text' value='$dt_spk->qty' class='form-control input-sm' id='used_qty_$loop' required name='dt[$loop][qty]' readonly></td>
                                            ...
                                            <td id='diskon_$loop'><input type='text' value='$dt_spk->diskon' class='form-control'  id='used_diskon_$loop' required name='dt[$loop][diskon]' readonly></td>
