					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<select id="id_customer" name="id_customer" class="form-control select" onchange="get_customer()" required>
								...
								<option value="<?= $customers->id_customer?>"><?= strtoupper(strtolower($customers->nm_customer))?></option>
									<?php } ?>
							</select>
						</div>
					</div>
					...
					<div class='form-group row'>
						...
						<div class='col-md-8'>
							<select id="top" name="top" class="form-control select" onchange="cek_customer()"required>
								...
								<option value="<?= $top->id?>"><?= strtoupper(strtolower($top->name))?></option>
									<?php } ?>
							</select>
						</div>
					</div>
							...
							<table class='table table-bordered table-striped'>
								...
								<tfoot>
									...
									<tr>
										...
										<th width='7%'><input type='text' class='form-control ppn' id='ppn'  name='ppn' value="11" readonly onblur='hitungPpn()'></th>                                            
...
<script type="text/javascript">
    ...
    function CariDetail(id){
		...
		$.ajax({
            type:"GET",
            url:siteurl+'penawaran/CariHarga',
            data:"id_category3="+id_material+"&id="+id,
            success:function(html){
		...
		$.ajax({
            type:"GET",
            url:siteurl+'penawaran/CariDiskon',
