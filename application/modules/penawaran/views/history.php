...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/penawaran/viewhistory/'.$record->no_penawaran."/".$record->revisi) ?>" title="view" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
			...
			<?php } 
				...
				<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('/penawaran/viewhistoryso/'.$record->no_penawaran."/".$record->revisi) ?>" title="view" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; 
			} ?>
