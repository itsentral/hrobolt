...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-warning btn-sm" href="<?= base_url('/penawaran/prosesapproval/'.$record->no_penawaran) ?>" title="Ajukan approval" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-mail-forward"></i>
				</a>
			<?php endif; ?>
