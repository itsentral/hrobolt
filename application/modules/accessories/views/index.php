<?php
    $ENABLE_ADD     = has_permission('Master_Barang_Stock.Add');
    $ENABLE_MANAGE  = has_permission('Master_Barang_Stock.Manage');
    $ENABLE_VIEW    = has_permission('Master_Barang_Stock.View');
    $ENABLE_DELETE  = has_permission('Master_Barang_Stock.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
