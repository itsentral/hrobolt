...
class Accessories_model extends BF_Model{
    ...
    public function __construct()
    {
		...
		$this->ENABLE_ADD     = has_permission('Master_Barang_Stock.Add');
		$this->ENABLE_MANAGE  = has_permission('Master_Barang_Stock.Manage');
		$this->ENABLE_VIEW    = has_permission('Master_Barang_Stock.View');
		$this->ENABLE_DELETE  = has_permission('Master_Barang_Stock.Delete');
    }
