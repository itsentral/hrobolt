...
<div class="box">
	<div class="box-body">
		...
		<div class="row">
			...
			<div class="col-md-6">
			<?php
			echo form_dropdown('pph_coa',$data_coa, '',array('id'=>'pph_coa','class'=>'form-control select2'));
			?>
			</div>			
		</div>
		<br />
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE)  : ?>
				...
				<td class="exclass"><input type="text" name="bank_nilai[]" class="form-control divide bank" id="bank_nilai<?=$numb?>" value="<?=$record->bank_nilai?>"></td>
				<td class="exclass"><input type="text" name="bank_admin[]" class="form-control divide" id="bank_admin<?=$numb?>" value="<?=$record->bank_admin?>"></td>
				<td class="exclass"><input type="text" name="pph_nilai[]" class="form-control divide pph" id="pph_nilai<?=$numb?>" value="<?=$record->nilai_pph?>"></td>
