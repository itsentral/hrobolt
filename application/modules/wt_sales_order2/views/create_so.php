								...
								<table class='table table-bordered table-striped'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        echo	"</select>
											...
											<td id='tgl_delivery_$loop'><input type='date' class='form-control input-sm tgldelivery' id='used_tgl_delivery_$loop' required name='dt[$loop][tgl_delivery]'></td>
                                         	<td id='qty_so_$loop'><input type='text' class='form-control input-sm qtyso' id='used_qty_so_$loop' required name='dt[$loop][qty_so]' onblur='HitungTotal($loop)'></td>
...
<script type="text/javascript">
	...
	$('#simpan-com').click(function(e){
		...
		$('#simpan-com2').click(function(e){
			...
			if(tgldelivery ==''){
					swal("Warning", "Tgl Delivery Tidak Boleh Kosong :)", "error");
					return false;
			}else{
			swal({
				  title: "Are you sure?",
