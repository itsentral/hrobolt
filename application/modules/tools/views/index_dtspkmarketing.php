...
<div class="box">
		<form method="post" action="<?= base_url() ?>tools/tampilkan_planning" autocomplete="off">
				<div class="row">
					<div class="col-sm-10">
						<div class="col-sm-2">
							<div class="form-group">
								<br>
								<label>Nomor Planning</label>
		...
		<thead>
					<tr class='bg-blue'>
						...
						<th width='7%'>No Planning</th>
						<th width='18%'>No SO</th>
						<th width='18%'>Nama Customer</th>
						<th width='7%'>Nama Sales</th>
						<th width='7%'>TOP</th>
		...
		<tr>
            ...
            <?php if($ENABLE_DELETE) : ?>
				<a class="btn btn-danger btn-sm delete" href="javascript:void(0)" title="Delete" data-no_planning="<?=$record->no_planning?>"><i class="fa fa-trash"></i>
				</a>
			<?php endif; ?>
	       </td>
...
<script type="text/javascript">
	...
	$(document).on('click', '.delete', function(e){
		...
		swal({
		  title: "Anda Yakin?",
		  text: "Data Planning akan di hapus.",
		  type: "warning",
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'tools/hapusplanning',
			  dataType : "json",
			  data:{'id':id},
