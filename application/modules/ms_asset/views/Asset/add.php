    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
			...
			<div class='form-group row'>
				...
				<?php if(empty($id)){ ?>
				<label class='label-control col-sm-2'><b>Photo <span class='text-red'>*</span></b></label> 
				<div class='col-sm-4'>             
					<?php 
			...
			<div class='form-group row'>		 	 
				<label class='label-control col-sm-2'><b>Shrinkage <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>             
