...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-id_bentuk="<?=$record->id_bentuk?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-sm edit" href="javascript:void(0)" title="Edit" data-id_bentuk="<?=$record->id_bentuk?>"><i class="fa fa-edit"></i>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_DELETE) : ?>
				<a class="btn btn-danger btn-sm delete" href="javascript:void(0)" title="Delete" data-id_bentuk="<?=$record->id_bentuk?>"><i class="fa fa-trash"></i>
				</a>
			<?php endif; ?>
			</td>
...
<script type="text/javascript">
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_bentuk/addBentuk',
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
